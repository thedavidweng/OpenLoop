...
| OpenLoop                                             | 根据提示词、歌词和音乐参数，在本地生成新音乐                  | Alpha v0.2.1 |
...
| Turbo | 16 GB+ Apple Silicon | 推荐默认                    |
...
详细指南见 [RESPONSIBLE_USE.md](./RESPONSIBLE_USE.md)。

---

## 已知限制

- 主要面向 Apple Silicon。Intel Mac 支持是实验性的。
- 首次初始化可能需要下载较大的模型。
